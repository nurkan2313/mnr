...
public interface CitesPermitRepository extends JpaRepository<CitesPermit, String> {
    ...
    @Query("SELECT c FROM CitesPermit c WHERE c.protectionMarkNumber = :protectionMarkNumber")
    Optional<CitesPermit> findByProtectionNumber(@Param("protectionMarkNumber") String protectionMarkNumber);
